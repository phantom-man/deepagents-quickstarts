...
def push_config():
    ...
    print(f"Video model ID in config: {DEFAULT_SYSTEM_CONFIG['agents']['Cinematographer']['capabilities'][0]['models'][0]['id']}")
    ...
    cache_file = os.path.join(os.path.dirname(__file__), "DeepAgents/.cache/prompts/deepagents-system-config.txt")
