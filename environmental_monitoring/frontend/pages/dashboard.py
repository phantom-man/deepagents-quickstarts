...
def update_quick_check(
    ...
    try:
        ...
        raw_code = weather.get("weather_code")
        ...
        weather_conditions = _WMO_CODES.get(raw_code, f"Code {raw_code}") if raw_code is not None else "Unknown"
        ...
        weather_summary = html.Div([
            ...
            html.P([html.Strong("Conditions: "), weather_conditions if has_weather else "Unavailable"])
