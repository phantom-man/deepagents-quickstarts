...
Output-Only Mode: Input handled by run_atlas.py
"""
...
# NOTE: atlas_db is orphaned (SQLite removed 2026-01-20).
    ...
    if REPLICATE_AVAILABLE and os.getenv("REPLICATE_API_TOKEN"):
        try:
            ...
            if os.path.exists(voice_path):
                ...
                logger.warning(
                    f"Voice file not found at {voice_path}. Using fallback URL."
                )
                speaker_input = (
                    "https://replicate.delivery/pbxt/Jt79w0xsT6GCR01c0fK8/male.wav"
                )
...
if __name__ == "__main__":
    ...
    print("----------------------------------------------")
    print("NOTE: Input is handled via DeepAgents/run_atlas.py")
