...
def save_results(papers: List[Dict[str, Any]], output_file: Optional[str] = None) -> None:
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fetch academic papers via Semantic Scholar.")
