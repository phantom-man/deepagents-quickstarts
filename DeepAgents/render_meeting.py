...
def render_meeting(
    transcript_path: str = TRANSCRIPT_FILE, output_path: str = FINAL_AUDIO_FILE
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input", default=TRANSCRIPT_FILE, help="Path to input transcript JSON"
    )
    parser.add_argument(
        "--output", default=FINAL_AUDIO_FILE, help="Path to output WAV file"
    )
