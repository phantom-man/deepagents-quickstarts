...
try:
    ...
    response = llm.invoke([HumanMessage(content="Hello! Please confirm this is a test trace.")])
    ...
    if runs:
        ...
        print("⚠️ No runs returned yet. It might take a few more seconds or configuration is partial.")
