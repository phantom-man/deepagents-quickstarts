...
class AssetValidator:
    ...
    def _check_pydub(self) -> bool:
        ...
        try:
            import pydub  # type: ignore[import-not-found]  # noqa
    ...
    def _check_opencv(self) -> bool:
        ...
        try:
            import cv2  # type: ignore[import-not-found]  # noqa
...
def extract_metadata(
    file_path: Union[str, Path], asset_type: str
) -> Dict[str, Any]:
    ...
    if asset_type == "video" and validator._opencv_available:
        try:
            import cv2  # type: ignore[import-not-found]
    ...
    if asset_type == "audio" and validator._pydub_available:
        try:
            from pydub import AudioSegment  # type: ignore[import-not-found]
    ...
    if duration_seconds is not None:
        ...
        formatted = validator._format_duration(duration_seconds)
        if formatted:
