...
class ModelRegistry:
    ...
    def _load_default_models(self):
        ...
        self.register(
            ModelInfo(
                ...
                required_inputs=[
                    InputRequirement.TEXT_PROMPT
                ],  # Just needs lyrics + prompt
    ...
    def get_by_category(
        self, category: ModelCategory, exclude_deprecated: bool = True
    ) -> List[ModelInfo]:
    ...
    def get_compatible_generators(
        self, requirement: InputRequirement
    ) -> List[ModelInfo]:
        """
    ...
    def get_models_for_dropdown(self, category: ModelCategory) -> Dict[str, str]:
        """
